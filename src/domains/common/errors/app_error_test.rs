...
fn test_app_error_status_codes() {
    ...
    assert_eq!(AppError::ValidationError("".into(), None).status_code(), StatusCode::UNPROCESSABLE_ENTITY);
    assert_eq!(AppError::DatabaseError("".into()).status_code(), StatusCode::INTERNAL_SERVER_ERROR);
    ...
    assert_eq!(AppError::PayloadTooLarge("".into()).status_code(), StatusCode::PAYLOAD_TOO_LARGE);
}
